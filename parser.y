...
%union
{
	...
	FormalList * fl; FormalRestList * frl; FormalRest * fr;
	PrimeType * prt; Type * type; TypeIndexList * tp_i;
	StatementList * sl; Statement * s;
	Index * i; Exp * e; Object * obj; 
	ExpList * el; ExpRestList * erl; ExpRest * er;
	IntLiteral * in_l; StringLiteral * st_l; Ident * id;
}
...
// Root of AST
extern Program * programRoot; // = NULL;
extern TableNode * rootScope; // = NULL;
extern bool programTypeError; // = false;
